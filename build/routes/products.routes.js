...
var service = new products_service_1.default();
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                q = req.query.q;
                return [4 /*yield*/, service.find(q)];
            case 1:
                products = _a.sent();
                if (products)
                    return [2 /*return*/, res.status(201).json(products)];
                return [2 /*return*/, res.status(404).send('Error getting products')];
        }
    });
}); });
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, service.findOne(id)];
            case 1:
                product = _a.sent();
                if (product)
